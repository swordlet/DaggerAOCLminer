...
#define OPENCL_PLATFORM_INTELFPGA  255

#define MAX_CL_DEVICES 16

namespace XDag
{
    class AOCLMiner : public Miner
    {
    public:
        /* -- default values -- */
        // Default value of the local work size. Also known as workgroup size.
        static const uint32_t _defaultLocalWorkSize = 512;
        ...
        AOCLMiner(uint32_t index, XTaskProcessor* taskProcessor);
        virtual ~AOCLMiner();
    ...
    private:
		...
		cl::vector<unsigned char> _kernelBinary;
    };
}
