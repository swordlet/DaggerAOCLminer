...
#include "MinerEngine/AOCLMiner.h"
...
private:
    ...
    unsigned _globalWorkSizeMultiplier = AOCLMiner::_defaultGlobalWorkSizeMultiplier;
    unsigned _localWorkSize = AOCLMiner::_defaultLocalWorkSize;
    bool _useNvidiaFix = false;
    bool _disableFee = false;
    uint32_t _nvidiaSpinDamp = AOCLMiner::_defaultNvidiaSpinDamp;
